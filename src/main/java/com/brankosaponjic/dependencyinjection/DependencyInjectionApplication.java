...
public class DependencyInjectionApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("_____ Which Pet Is The Best _______");
		PetBrokenController petBrokenController =
				(PetBrokenController) ctx.getBean("petBrokenController");
		System.out.println(petBrokenController.whichPetIsTheBest());
	}
